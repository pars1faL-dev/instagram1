...
<html lang="en">
  ...
  <body>
			...
			<div class="col-8 px-0 my-2"> 
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<form class="rd" style="display: none" action="update.php" method="GET">
							<p><input class="form-control" type="text" name="id" value="<?php echo $stroka["id"] ?>"></p>
							<p><input class="form-control" cols="10" rows="5" type="text" name="text" value="<?php echo $stroka["text"] ?>"></p>
							<p><input class="form-control" cols="10" rows="5" type="text" name="img" value="<?php echo $stroka["img"] ?>"></p>
							<button class="btn rounded bg-white border">Изменить</button>
						</form>		
						<button class="btn rounded bg-success btnn">Редактировать</button>		
					</div>
				</div>
				<!-- ПОСТ ЗАКРЫЛСЯ-->
			<?php } ?>		
					...
					<div class="col-12">
						<div class="row">
							...
							<div class="col-10">
								...
								<p class="text-secondary mb-0">__erikiki__</p>
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		let input = document.querySelectorAll(".rd");
